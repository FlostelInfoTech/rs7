...
//! for both HTTP clients and servers.
...
impl TlsClientConfig {
    ...
    pub fn with_ca_cert(ca_cert_path: impl AsRef<Path>) -> Result<Self> {
        ...
        let ca_certs = certs(&mut reader)
            ...
            .map_err(|e| Error::InvalidUrl(format!("Failed to parse CA certificate: {}", e)))?;

        for cert in ca_certs {
            root_store
                .add(cert)
                .map_err(|e| Error::InvalidUrl(format!("Failed to add CA certificate: {}", e)))?;
        }
    ...
    pub fn with_mtls(
        ...
        let client_certs: Vec<CertificateDer> = certs(&mut cert_reader)
            .collect::<std::result::Result<Vec<_>, _>>()
            .map_err(|e| Error::InvalidUrl(format!("Failed to parse client certificate: {}", e)))?;
        ...
        let client_key = private_key(&mut key_reader)
            .map_err(|e| Error::InvalidUrl(format!("Failed to parse private key: {}", e)))?
            .ok_or_else(|| Error::InvalidUrl("No private key found in file".to_string()))?;

        let config = ClientConfig::builder()
            .with_root_certificates(root_store)
            .with_client_auth_cert(client_certs, client_key)
            .map_err(|e| Error::InvalidUrl(format!("Failed to configure client auth: {}", e)))?;
...
impl TlsServerConfig {
    ...
    pub fn new(
        ...
        let certs: Vec<CertificateDer> = certs(&mut cert_reader)
            .collect::<std::result::Result<Vec<_>, _>>()
            .map_err(|e| Error::InvalidUrl(format!("Failed to parse server certificate: {}", e)))?;
        ...
        let config = ServerConfig::builder()
            ...
            .map_err(|e| Error::InvalidUrl(format!("Failed to configure server TLS: {}", e)))?;
    ...
    pub fn with_mtls(
        ...
        let client_cert_verifier = rustls::server::WebPkiClientVerifier::builder(Arc::new(client_auth_roots))
            .build()
            .map_err(|e| Error::InvalidUrl(format!("Failed to build client verifier: {}", e)))?;
